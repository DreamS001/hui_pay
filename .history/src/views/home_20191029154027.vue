  ...
  <div class="dashboard-container">
    <div class="dashboard-editor-container">
      ...
      <el-row :gutter="32">
        ...
        <el-col :xs="24" :sm="24" :lg="16">
          <div class="" style="height:486.5px;">
            <el-row>
              <el-col :xs="24" :sm="24" :lg="24">
                <div class="" style="margin:-7.5px;">
                  <div style="margin:7.5px; margin-right:30px;">
                    <div style="padding: 10px 15px;line-height: 24px;background:#fff;box-sizing:border-box;">
                      <div></div>
                      <div>
                        <div></div>
                        <div></div>
        ...
        <!-- <el-col :xs="24" :sm="12" :lg="12">
          <article style="width:100%;height:263px;background: #fff">
            <div class="main-home">
              <div class="main-home-d">
                <div class="main-home1">
                  <div class="main-home1-d">
                    <div>
                      快捷入口
