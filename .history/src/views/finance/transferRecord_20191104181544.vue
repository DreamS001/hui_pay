    ...
    <div class="papel-box">
      ...
      <div style="width:100%!important;" class="table-box">
        ...
        <el-table :data="list" style="width: 100%!important" stripe :header-cell-class-name="handlemyclass">
          ...
          <el-table-column prop="type" label="meta.titles[0]">
            <template slot-scope="scope">{{scope.row.type|formatType}}</template>
          </el-table-column>
          <el-table-column prop="addtime" label="meta.titles[0]" v-model="addtime"></el-table-column>
          <el-table-column prop="operator_id" label="meta.titles[0]" v-model="operator_id"></el-table-column>
          <el-table-column prop="web_ip" label="meta.titles[0]" v-model="web_ip"></el-table-column>
          <el-table-column prop="loc_info" label="meta.titles[0]"></el-table-column>
        </el-table>
      </div>
