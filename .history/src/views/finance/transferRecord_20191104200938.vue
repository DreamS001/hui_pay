    ...
    <div class="papel-box">
      ...
      <div style="width:100%!important;" class="table-box">
        <el-table :data="list" style="width: 100%!important" stripe :header-cell-class-name="handlemyclass">
          ...
          <el-table-column prop="addtime" label="操作时间" v-model="addtime" :formatter="timestampToTime"></el-table-column>
...
export default {
    ...
    timestampToTime (row, column) {
      var date = new Date(row.cjsj) *1000 //时间戳为10位需*1000，时间戳为13位的话不需乘1000
      ...
      console.log(timestampToTime (1533293827000))
        ...
        console.log(date)
				// 转换时间戳
				date.forEach((v, i) => {
					date[i].addtime = moment(date[i].addtime).format("YYYY-MM-DD");
				});
				this.list = date
