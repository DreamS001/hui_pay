              ...
              <div class="block" style="margin-bottom:20px;min-width:600px">
                ...
                <div>
                  <el-table :data="list" style="width: 100%!important;padding:5px 0;box-sizing: border-box;" stripe :header-cell-class-name="handlemyclass">
                    <el-table-column :cell-class-name="colorblueclass" prop="create_time" label="所属合伙人oem" align="center" min-width="120px"></el-table-column>
                    <el-table-column prop="product_name" label="所属代理商" align="center" min-width="100px"></el-table-column>
                    <el-table-column prop="product_name" label="商户名称" align="center" min-width="100px"></el-table-column>
                    <el-table-column prop="product_name" label="联系人" align="center" min-width="100px"></el-table-column>
                    <el-table-column prop="product_name" label="联系电话" align="center" min-width="100px"></el-table-column>
                    <el-table-column prop="product_name" label="支付宝费率" align="center" min-width="100px"></el-table-column>
                    <el-table-column prop="product_name" label="微信费率" align="center" min-width="100px"></el-table-column>
                    <el-table-column prop="product_name" label="加入时间" align="center" min-width="100px"></el-table-column>
                    <el-table-column prop="order_status" label="支付类型" align="center" min-width="100px">
