              ...
              <div class="block" style="margin-bottom:20px;min-width:600px">
                ...
                <div>
                  <el-table :data="list" style="width: 100%!important;padding:5px 0;box-sizing: border-box;" stripe :header-cell-class-name="handlemyclass">
                    <el-table-column :cell-class-name="colorblueclass" prop="create_time" label="ID" align="center" min-width="120"></el-table-column>
                    <el-table-column prop="product_name" label="商户名称" align="center" min-width="100"></el-table-column>
                    <el-table-column prop="product_name" label="店铺类目" align="center" min-width="100"></el-table-column>
                    ...
                    <el-table-column prop="product_name" label="联系邮箱" align="center" min-width="100"></el-table-column>
                    ...
                    <el-table-column prop="order_status" label="商户状态" align="center" min-width="100">
                    <el-table-column prop="order_status" label="加入时间" align="center" min-width="100">
                    ...
                    <el-table-column label="操作" align="center" min-width="200">
                      <template slot-scope="scope">
                        ...
                        <span class="s-btn" @click="edited(scope.$index,scope.row)">费率修改</span>
                      </template>
                    </el-table-column>
                  </el-table>
                  <!-- 分页器 -->
