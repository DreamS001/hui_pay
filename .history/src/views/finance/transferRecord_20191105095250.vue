    ...
    <div class="papel-box">
      <div class="nav-a">
		...
		<div class='create_time'>
          ...
          <el-date-picker v-model="createtime" type="daterange" size="mini" range-separator="至" :start-placeholder="startPlaceHoler" :end-placeholder="endPlaceHoler" format='yyyy-MM-dd'  @change="timeChange"></el-date-picker>
        </div>
          <div class="operation">
...
export default {
	...
	methods: {
      ...
      if (this.startPlaceHoler=='' || this.endPlaceHoler=='') {
        ...
        this.createtime=this.startDate+','+this.endDate
      }
