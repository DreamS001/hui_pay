              ...
              <div class="kaifang-weixin" style="width:100%;margin-bottom:30px;">
                <el-form ref="form" :model="form2">
                  <el-form-item label="消息校验Token">
                    ...
                    <span  data-clipboard-action="copy" :data-clipboard-text="i.token" @click="copyUrl" style="display:inline-block;margin-left:20px;cursor:pointer;color: #999">点击复制</span>
                  </el-form-item>
