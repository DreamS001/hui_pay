              ...
              <div class="top-tabs">
                <template>
                  <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                    ...
                    <!-- 腾讯云存储 -->
                    <el-tab-pane label="腾讯云存储" name="third">角色管理</el-tab-pane>
                    <el-tab-pane label="阿里云存储" name="fourth">定时任务补偿</el-tab-pane>
                  </el-tabs>
                </template>
              </div>
              <div class="left-line-content">
...
<style>
  ...
  .right-main1 .avatar {
    ...
    /* 开放平台 和短信配置 */
  .right-main2 .el-form-item__label,.right-main3 .el-form-item__label,.right-main4 .el-form-item__label{
    width:200px !important;
    font-size: 14px;
    color: #606266;
    font-weight: 400;
  }
  .right-main2 .el-form-item__label::before,.right-main3 .el-form-item__label::before,.right-main4 .el-form-item__label::before{
    content: '*';
    color: #ff4949;
    margin-right: 4px;
  }
  .right-main2 .el-input, .right-main3 .el-input,.right-main4 .el-input{
    width:410px;
  }
  .right-main2 .el-form-item__content,.right-main3 .el-form-item__content,.right-main4 .el-form-item__content{
    margin-left: 200px !important;
  }
  /* 图片存储配置 */
  .right-main4  .clearfix:before,.right-main4 .clearfix:after {
    display: table;
    content: "";
  }
  .right-main4 .clearfix:after {
    clear: both
  }
  .item_left{
    margin-top:20px;
