              ...
              <div class="block tabs" style="margin-bottom:20px;min-width:600px" v-else >
                <template>
                  <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                    ...
                    <el-tab-pane label="支付宝信息" name="second">配置管理</el-tab-pane>
                ...
                <!-- <el-collapse v-model="activeNames" @change="handleChange">
                  <el-collapse-item title="基本信息" name="1">
                    <div class="content">
                      <h1 style="color: rgb(17, 17, 17); margin: 10px 0px 14px;">账户信息</h1>
                      <div class="content_text">
                        <div class="layui-form-mid">商户名称：</div>
                        <div class="layui-form-mid layui-word-aux">小易水果3</div>
                      </div>
                  ...
                  <el-collapse-item title="结算信息" name="2">
                    <div class="content">
                      <h1 style="color: rgb(17, 17, 17); margin: 10px 0px 14px;">商家对公银行卡信息</h1>
                      <div class="content_text">
                        <div class="layui-form-mid">持卡人：</div>
                        <div class="layui-form-mid layui-word-aux">伊蕾</div>
                      </div>
                  ...
                  <el-collapse-item title="证件信息" name="3">
                    <div class="content">
                      <h1 style="color: rgb(17, 17, 17); margin: 10px 0px 14px;">证件质料</h1>
                      <div class="certificate_content">
                        <div class="content_text">
                          <div class="layui-form-mid">身份证正面</div>
                          <div class="layui-form-mid layui-word-aux">
