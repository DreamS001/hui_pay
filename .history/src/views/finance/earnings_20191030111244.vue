            ...
            <div class="left-line-content">
              <el-form ref="form" :model="form" label-width="80px">
                ...
                <el-form-item label="网站ico">
                  ...
                  <p style="margin:0;margin-left:80px;padding:0;color: rgb(204, 204, 204);display:block">建议尺寸 64 x 64px。该图片后缀必须为ico <a href="http://www.faviconico.org/favicon">立即生成</a></p>
                </el-form-item>
                <el-form-item label="登录Logo">
                  <template>
                    <div>
