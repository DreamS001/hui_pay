        ...
        <div class="right-main-box">
          ...
          <div v-if="imain3==ind">
            <div class="right-main right-main3" >
              ...
              <div class="left-line-content">
                <el-form ref="form" :model="form" label-width="80px">
                  <el-form-item label="阿里大鱼KeyId" :error="errorMsg">
                    <el-input placeholder="请输入阿里大鱼KeyId" v-model="form.name" auto-complete="off" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="阿里大鱼密钥">
                    <el-input placeholder="请输入阿里大鱼密钥" v-model="form.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="阿里大鱼签名">
                    <el-input placeholder="请输入阿里大鱼签名" v-model="form.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="会员码激活模板code">
                    <el-input placeholder="请输入会员码激活模板code" v-model="form.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="二维码激活模板code">
                    <el-input placeholder="请输入二维码激活模板code" v-model="form.name" clearable></el-input>
                  </el-form-item>
                  <!-- <p style="  box-sizing: border-box;padding-left:200px;font-size:14px; color:#f00;"><b style="font-size:14px;display:inline-block;"> 注意事项: </b> 网站避免强制使用https,避免授权后页面不跳转</p> -->
                  <el-form-item style="">
                    <el-button type="primary" @click="onSubmit">保存</el-button>
