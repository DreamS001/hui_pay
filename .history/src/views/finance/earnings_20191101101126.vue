                ...
                <el-card class="box-card">
                  ...
                  <div class="text item">
                    ...
                    <div class="" style="padding-top: 20px;">
                      <el-form ref="form" :model="form" label-width="80px">
                        <el-form-item label="选择本级代理：" class="star">
                            <el-checkbox-group v-model="checkList"  v-for="item in checkList" :key="item">
                              <el-checkbox label="测试一级代理">{{item}}</el-checkbox>
                              <el-checkbox label="代理111">{{item}}</el-checkbox>
                              <el-checkbox label="代理1">{{item}}</el-checkbox>
                              <el-checkbox :label="item"></el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                        <el-form-item label="已选择：" v-model="checkList" style="border-bottom:1px solid #e9e9eb;padding-bottom:22px;">
                            <el-tag type="info">测试一级代理</el-tag>
                            <el-tag type="info">代理111</el-tag>
                            <el-tag type="info">代理1</el-tag>
                        </el-form-item>
                        <el-form-item label="选择下级代理：" class="star">
                            <el-checkbox-group v-model="checkList">
                              <el-checkbox  label="daili2">daili2</el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                        <el-form-item label="已选择：" v-model="checkList" style="border-bottom:1px solid #e9e9eb;padding-bottom:22px;">
                            <el-tag type="info">daili2</el-tag>
                        </el-form-item>
                        <el-form-item label=" " >
                            <el-button class="item_left" type="primary" @click="onSubmit" style="margin-left:45px">保存</el-button>
                        </el-form-item>
