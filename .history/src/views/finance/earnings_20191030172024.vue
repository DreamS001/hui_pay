        ...
        <div class="right-main-box">
          ...
          <div v-if="imain2==ind">
            ...
            <div class="right-main right-main2" >
              ...
              <div class="kaifang-weixin">
                <el-form ref="form" :model="form2" label-width="200px">
                ...
                <!-- <div>
                <label for="m-token">消息校验Token</label>
                <el-input placeholder="" v-model="form.name" id="m-token"></el-input>
                </div>
                <div>
                  <label for="m-token">消息加密key</label>
                  <el-input placeholder="" v-model="form.name" id="m-token"></el-input>
                </div> -->
              </div>
