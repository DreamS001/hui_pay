              ...
              <div class="kaifang-weixin" style="width:100%;margin-bottom:30px;">
                <el-form ref="form" :model="form2">
                  <el-form-item label="消息校验Token">
                    <el-input placeholder="" v-model="form.token" :title='address' readonly="readonly"></el-input>
                    <span v-clipboard:copy='address' v-clipboard:success="onCopy" v-cliboard:error='onError' style="display:inline-block;margin-left:20px;cursor:pointer;color: #999">点击复制</span>
                  </el-form-item>
