...
<style>
  ...
  /* 图片存储配置，验证码配置 */
  .right-main4  .clearfix:before,.right-main4 .clearfix:after, .right-main5  .clearfix:before,.right-main5 .clearfix:after {
    display: table;
    content: "";
  }
  .right-main4 .clearfix:after, .right-main5 .clearfix:after {
    clear: both
  }
  .right-main4 .item_left , .right-main5 .item_left{
    margin-top:20px;
    margin-left:220px;
  }
