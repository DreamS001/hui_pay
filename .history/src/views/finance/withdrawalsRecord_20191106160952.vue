                          ...
                          <div class="titles">
                            ...
                            <div class="pop-content" :class="{ispopUp2:ispopUp2}" style="width:40%;height:50%; background-color: #f2f2f2">
                              <div class="" style="    background-color: #F8F8F8;height:40px;border-bottom: 1px solid #eee;border-radius: 2px 2px 0 0;">
                                <span style="display:inline-block;font-size:14px;float:left;margin-left:15px;margin-top:15px;">填写微信号</span>
                                <span style="display:inline-block;font-size:25px;float:right;margin-right:15px;margin-top:15px;" @click="unpopUP" class="el-icon-close"></span>
                              </div>
                              <div>
