    ...
    <div class="papel-box">
      ...
      <div style="width:100%!important;" class="table-box">
        ...
        <el-table :data="list" style="width: 100%!important" stripe :header-cell-class-name="handlemyclass">
          ...
          <el-table-column prop="operator_id" :label="meta.titles[3]" v-model="operator_id"></el-table-column>
          <el-table-column prop="web_ip" :label="meta.titles[4]" v-model="web_ip"></el-table-column>
          <el-table-column prop="loc_info" label="操作"></el-table-column>
        </el-table>
      </div>
...
export default {
	...
	methods: {
        ...
        this.list.forEach((v, i) => {
					this.list[i].complete_time = moment(this.list[i].complete_time).format("YYYY-MM-DD");
        });
