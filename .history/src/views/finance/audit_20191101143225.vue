              ...
              <div class="left-line-content">
                <el-form ref="form" :model="mainland"   label-width="80px">
                  ...
                  <el-form-item label="异步回调域名配置">
                    <el-input placeholder="请输入异步回调域名配置" v-model="mainland.comConf" readonly="readonly"></el-input>
                    <span  class="clickspan" title="点击复制" v-clipboard:copy='mainland.comConf' v-clipboard:success='onCopy' v-clipboard:error='onError' style="">点击复制</span>
                  </el-form-item>
                  <el-form-item label="新大陆pem证书">
                    <el-input placeholder="请上传apiclient_key证书" v-model="mainland.apiclient_key" :disabled="true" clearable></el-input>
                    <el-upload
                      class="upload-demo"
                      action="https://jsonplaceholder.typicode.com/posts/"
                      :on-preview="handlePreview"
                  ...
                  <el-form-item label="多域名配置">
                    <el-input placeholder="新大陆多域名配置(多个请用逗号隔开)" v-model="mainland.moreCom" clearable></el-input>
                  </el-form-item>
                  <el-form-item style="">
                    <el-button type="primary" @click="onSubmit">保存</el-button>
                  </el-form-item>
...
<style>
  ...
  .right-main2 .el-button:focus,.right-main2 .el-button:hover，.right-main3 .el-button:focus,.right-main3 .el-button:hover {
    color: #409EFF;
    border-color: #c6e2ff;
