                    ...
                    <el-tab-pane label="支付宝信息" name="second">
                      <div class="tabs-content">
                        ...
                        <div class="content-d">
                          ...
                          <div class="content">
                            <div class="content_text">
                              <div class="layui-form-mid"><div class="display:inline-block;background-color:">支</div>支付宝费率：</div>
                              <div class="layui-form-mid layui-word-aux">0.38%</div>
                            </div>
                            <div class="content_text">
                            ...
                            <div class="content_text">
                              ...
                              <div class="layui-form-mid layui-word-aux">授权成功<span>点击重新扫码授权</span></div>
                            </div>
                          </div>
                        </div>
                        <div class="content-d">
