    ...
    <div>
      <div class="system-right">
        <div class="right-main-box">
          <div class="right-main right-main-" >
            <div class="nav">
                  ...
                  <el-table :data="list" style="width: 100%!important;padding:5px 0;box-sizing: border-box;" stripe :header-cell-class-name="handlemyclass">
                    ...
                    <el-table-column prop="alipayaudit" label="支付类型" align="center" min-width="100">
                      <template slot-scope="scope">
                        <el-tag type="success" v-if="scope.row.alipayaudit==300">未开通</el-tag>
                        <el-tag type="danger" v-if="scope.row.alipayaudit==500">直连</el-tag>
                        <el-tag type v-if="scope.row.alipayaudit==100">间连</el-tag>
                      </template>
                    </el-table-column>
