    ...
    <div class="papel-box">
      <div class="nav-a">
		...
		<div class='create_time'>
          ...
          <el-date-picker v-model="addtime" type="daterange" size="mini" range-separator="至" :start-placeholder="startPlaceHoler" :end-placeholder="endPlaceHoler" format='yyyy-MM-dd' ></el-date-picker>
        </div>
          <div class="operation">
...
export default {
	...
	methods: {
      ...
      if (this.startPlaceHoler=='' || this.endPlaceHoler=='') {
        ...
        this.addtime=this.startPlaceHoler+','+this.endPlaceHoler
      }
		...
		queryData() {
			this.pageNumber=1
			this.startDate = moment(this.addtime[0]).format("YYYY-MM-DD")
			this.endDate = moment(this.addtime[1]).format("YYYY-MM-DD")
      ...
      //     this.endDate = ''
      //   } else {
      //     this.startDate = moment(this.createtime[0]).format('YYYY-MM-DD')
      //     this.endDate = moment(this.createtime[1]).format('YYYY-MM-DD')
      //   }
      // },
		// 导出
		download() {
