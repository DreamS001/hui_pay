              ...
              <div class="left-line-content">
                <el-form ref="form" :model="smsConfig"   label-width="80px">
                  <el-form-item label="服务商机构号">
                    <el-input placeholder="请输入服务商机构号" v-model="smsConfig.keyid" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="服务商机构秘钥">
                    <el-input placeholder="请输入服务商机构秘钥" v-model="smsConfig.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="异步回调MD5秘钥">
                    <el-input placeholder="请输入异步回调MD5秘钥" v-model="smsConfig.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="异步回调域名配置">
                    <el-input placeholder="请输入异步回调域名配置" v-model="smsConfig.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="新大陆pem证书">
                    <el-input placeholder="请上传apiclient_key证书" v-model="smsConfig.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="多域名配置">
                    <el-input placeholder="新大陆多域名配置(多个请用逗号隔开)" v-model="smsConfig.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item style="">
                    <el-button type="primary" @click="onSubmit">保存</el-button>
                  </el-form-item>
