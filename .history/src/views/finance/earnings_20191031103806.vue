              ...
              <div class="kaifang-weixin" style="width:100%;margin-bottom:30px;">
                <el-form ref="form" :model="form2">
                  ...
                  <el-form-item label="消息加密key">
                    <el-input placeholder="" v-model="form2.name2" readonly="readonly"></el-input>
                    <span title="点击复制" v-clipboard:copy='form2.name2' v-clipboard:success='onCopy' v-clipboard:error='onError' style="display:inline-block;margin-left:20px;cursor:pointer;color: #999">点击复制</span>
                  </el-form-item>
                  <el-form-item label="登录授权的发起页域名">
                    <el-input placeholder="" v-model="form2.name3" readonly="readonly"></el-input>
                    <span title="点击复制" v-clipboard:copy='form2.name3' v-clipboard:success='onCopy' v-clipboard:error='onError' style="display:inline-block;margin-left:20px;cursor:pointer;color: #999">点击复制</span>
                  </el-form-item>
