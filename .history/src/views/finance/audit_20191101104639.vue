        ...
        <div class="right-main-box">
          ...
          <div v-if="imain1==ind">
            <div class="right-main right-main2" >
              <div class="left-Line">
                <span>微信服务商配置</span>
                <el-switch style="display: block" v-model="value2" active-color="#13ce66" inactive-color="#ff4949" active-text="关闭" inactive-text="开启"></el-switch>
              </div>
          ...
          <div v-if="imain2==ind">
            <div class="right-main right-main3" >
              <div class="left-Line">新大陆支付配置</div>
              <div class="left-line-content">
