              ...
              <div class="kaifang-weixin" style="width:100%;margin-bottom:30px;">
                <el-form ref="form" :model="form2">
                  <el-form-item label="消息校验Token">
                    ...
                    <span  class="copy" data-clipboard-action="copy" :data-clipboard-text="form2.tokenurl" @click="copyUrl" style="">点击复制</span>
                  </el-form-item>
                </el-form>
                  <el-form-item label="消息加密key">
                    <el-input placeholder="" v-model="form2.name2" readonly="readonly"></el-input>
                    <span class="clickspan" title="点击复制" v-clipboard:copy='form2.name2' v-clipboard:success='onCopy' v-clipboard:error='onError' style="">点击复制</span>
                  </el-form-item>
