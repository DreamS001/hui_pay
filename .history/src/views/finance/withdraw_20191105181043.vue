            ...
            <div class="nav">
              <div class="block" style="margin-bottom:20px;min-width:600px" v-if="isshow">
                <div>
                  ...
                  <div class="roles">
                    <span>角色选择：</span>
                    <el-select v-model="value1" placeholder="请选择合伙人">
                      <el-option
                    ...
                    <el-select v-model="value2" placeholder="请选择代理商">
                      <el-option
                    ...
                    <el-select v-model="value3" placeholder="请选择拓展员">
                      <el-option
                    ...
                    <el-select v-model="value4" placeholder="请选择商家">
                      <el-option
                ...
                <div class="zlist">
                  <el-table :data="list" style="width: 100%!important;padding:5px 0;box-sizing: border-box;" stripe :header-cell-class-name="handlemyclass">
                    <el-table-column  prop="par_name" label="所属合伙人/oem" align="center" min-width="120"></el-table-column>
              ...
              <div class="block fold" style="margin-bottom:20px;min-width:600px" v-else >
                <el-collapse v-model="activeNames" @change="handleChange">
                  ...
                  <el-collapse-item title="证件信息" name="3">
                    <div class="content">
                      <h1 style="color: rgb(17, 17, 17); margin: 10px 0px 14px;">证件照片</h1>
...
export default {
  data() {
    return {
      ...
      endDate: '',
      partnerOptions:[
        {value:'选项1',lable:'杭州水果'},
        {value:'选项2',lable:'杭州水果店'},
      ...
      merchantOptions:[
        {value:'选项1',lable:'杭州水果'},
        {value:'选项2',lable:'杭州水果店'},
        {value:'选项3',lable:'小易水果2'},
        {value:'选项4',lable:'测试餐饮'},
        {value:'选项5',lable:'测试123'},
