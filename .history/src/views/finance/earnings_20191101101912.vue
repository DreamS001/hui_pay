                      ...
                      <el-form ref="form" :model="form" label-width="80px">
                        <el-form-item label="选择本级代理：" class="star">
                            <el-checkbox-group v-model="checkList"  >
                              ...
                              <el-checkbox label="代理111" checked="false"></el-checkbox>
                              <el-checkbox label="代理1" checked></el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                        <el-form-item label="已选择：" style="border-bottom:1px solid #e9e9eb;padding-bottom:22px;">
                            <el-tag type="info" v-for="item in checkList" :key="item">{{item}}</el-tag>
                        </el-form-item>
