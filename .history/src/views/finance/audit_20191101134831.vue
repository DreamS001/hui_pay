            ...
            <div class="right-main right-main2" >
              ...
              <div class="kaifang-weixin" style="width:100%;margin-bottom:30px;">
                <el-form ref="form" :model="form2">
                  <el-form-item label="">
                    <el-input placeholder="请输入支付宝Pid" v-model="form2.tokenurl" ></el-input>
                  </el-form-item>
                  <el-form-item label="支付宝Pid">
                    <el-input placeholder="请输入支付宝Pid" v-model="form2.keyurl" ></el-input>
                  </el-form-item>
                  <el-form-item label="登录授权的发起页域名">
                    <el-input placeholder="" v-model="form2.name3" ></el-input>
                  </el-form-item>
