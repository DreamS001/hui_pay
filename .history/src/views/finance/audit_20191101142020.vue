              ...
              <div class="left-line-content">
                <el-form ref="form" :model="mainland"   label-width="80px">
                  <el-form-item label="服务商机构号">
                    <el-input placeholder="请输入服务商机构号" v-model="mainland.organization" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="服务商机构秘钥">
                    <el-input placeholder="请输入新大陆服务商支付秘钥" v-model="mainland.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="异步回调MD5秘钥">
                    <el-input placeholder="请输入新大陆服务商异步回调秘钥" v-model="mainland.name" clearable></el-input>
                  </el-form-item>
                  <el-form-item label="异步回调域名配置">
                    <el-input placeholder="请输入异步回调域名配置" v-model="mainland.name" clearable></el-input>
                  </el-form-item>
