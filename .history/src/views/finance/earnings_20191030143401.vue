    ...
    <div>
      ...
      <div class="system-right">
        <div class="right-main-box">
          <div class="right-main" v-if="imain1==ind">
...
<style>
  ...
  .system-right .el-form-item__content{
    ...
    .system-right .el-form-item__content .el-button{
    margin-left: 80px;
  }
  .system-right .el-form-item__content>div{
  ...
  .system-right .upload-box1 .avatar-uploader .el-upload,.system-right .upload-box2 .avatar-uploader .el-upload {
    border: 1px dashed #d9d9d9;
    cursor: pointer;
    position: relative;
    overflow: hidden;
  ...
  .system-right .upload-box3 .avatar-uploader .el-upload{
    border: 1px dashed #d9d9d9;
    cursor: pointer;
    position: relative;
    overflow: hidden;
