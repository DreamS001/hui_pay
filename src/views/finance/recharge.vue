  ...
  <div class="wscn-http404-container">
    <div class="nav">
      <div class="block" style="margin-bottom:20px;min-width:600px">
        ...
        <span class="demonstration">充值流水号：</span>
    ...
    <div style="width:100%!important;margin:20px">
      ...
      >
        <el-table-column prop="create_time" label="日期" min-width="150"></el-table-column>
        <el-table-column prop="merchant_order_id" label="充值流水号" min-width="150"></el-table-column>
        <el-table-column prop="third_trade_id" label="第三方平台" min-width="150"></el-table-column>
        <el-table-column prop="charge_amount" label="充值金额（美金）" min-width="160"></el-table-column>
        <el-table-column prop="charge_token_id" label="充值账户" min-width="150"></el-table-column>
        <!-- <el-table-column prop="merchant_order_id" label="充值账号"></el-table-column> -->
        <!-- <el-table-column prop="purchase" label="所属银行"></el-table-column> -->
        <!-- <el-table-column prop="withdraw" label="投资方名称"></el-table-column> -->
        <el-table-column prop="order_status" label="状态" min-width="150">
...
export default {
  ...
  methods: {
    ...
    refresh() {
      (this.typee = 2), console.log(this.pageNo, this.pageSize);
      topupList(this.pageNo, this.pageSize).then(res => {
    ...
    handleCurrentChange(val) {
      ...
      if (this.clickQueryDate == false) {
        ...
        if(this.selectTime){
  topupQueryList(this.pageNo, this.pageSize1, this.time, this.times,this.input1).then(
          res => {
    ...
    getDate() {
      topupQueryList(this.pageNo, this.pageSize1,this.time, this.times,this.input1).then(res => {
        this.allList = res.list;
