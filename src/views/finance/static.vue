      ...
      <div>
        ...
        <div>
          ...
          >
            ...
            <el-table-column prop="sta_profit" label="静态钱包收益（美金）" min-width="170"></el-table-column>

            <el-table-column prop="device_expend" label="购买机器人支出（美金）"  min-width="180"></el-table-column>
            <el-table-column prop="cash_withdraw" label="提现支出（美金）" min-width="160"></el-table-column>
          </el-table>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    queryDate() {
      ...
      cashquery(this.pageNo, this.pageSize, this.time, this.times).then(res => {
        this.list = eval(res.list);
        this.total = res.total;
      });
