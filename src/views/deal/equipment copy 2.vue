            ...
            <div class="right-main right-main7" >
              <div class="top-tabs">
                <el-card class="box-card">
                  ...
                  <div class="text item">
                    <el-button type="primary" @click="drawer = true">添加banner</el-button>
                    <div class="" style="padding-top: 20px;">
                      <el-table :data="tableData" style="width: 100%">
                        <el-table-column prop="crudName" label="排序" align="center"></el-table-column>
                        <el-table-column prop="crudCode" label="banner图片" align="center"></el-table-column>
                        <el-table-column prop="domainClass" label="时间" align="center"></el-table-column>
              ...
              <div class="top-tabs">
                <el-card class="box-card">
                  ...
                  <div class="text item">
                    <div class="" style="padding-top: 20px;">
                      <el-table :data="tableData" style="width: 100%">
                        <el-table-column prop="crudName" label="姓名" align="center"></el-table-column>
                        <el-table-column prop="crudCode" label="手机号" align="center"></el-table-column>
                        <el-table-column prop="domainClass" label="备注" align="center"></el-table-column>
