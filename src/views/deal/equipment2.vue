...
<!--  网站管理/关于我们 -->
  <div class="wscn-http404-container">
                ...
                <el-card class="box-card">
                  ...
                  <div class="text item">
                    <div class="" style="padding-top: 20px;">
                      ...
                      <!-- <vue-ueditor-wrap v-model="defaultMsg" :config="myConfig"></vue-ueditor-wrap> -->
                    </div>
                  </div>
                  <hr style="width:100%;height:1px;background-color: #DCDFE6;margin: 24px 0;border-width:0;">
            ...
            <div class="right-main right-main7" >
              <div class="top-tabs">
                <el-card class="box-card">
                  ...
                  <div class="text item">
                    <div class="" style="padding-top: 20px;">
                      <el-form :model="ruleForm" ref="ruleForm" label-width="100px" style="box-sizing: border-box;" class="demo-ruleForm">
                        <el-form-item label="企业愿景" prop="name">
                          <el-input v-model="ruleForm.name" type="textarea" style="width:95%;"></el-input>
                        </el-form-item>
                        <el-form-item label="企业理念" prop="name">
                          <el-input v-model="ruleForm.name" type="textarea" style="width:95%;"></el-input>
                        </el-form-item>
                        <el-form-item label="价值观" prop="name">
                          <el-input v-model="ruleForm.name" type="textarea" style="width:95%;"></el-input>
                        </el-form-item>
                        <el-form-item label="使命" prop="name">
                          <el-input v-model="ruleForm.name" type="textarea" style="width:95%;"></el-input>
                          <div style="font-size:14px;color: rgb(192, 196, 204);margin-top:20px;">企业愿景、企业理念、价值观、使命长度建议不要超过40字(超出部分不显示)</div>
                        </el-form-item>
                        <el-form-item>
                  ...
                  <div class="text item">
                    ...
                    <div class="" style="padding-top: 20px;">
                      <el-table :data="tableData" style="width: 100%">
                        <el-table-column prop="crudName" label="日期(年/月)" align="center"></el-table-column>
                        <el-table-column prop="crudCode" label="简述" align="center"></el-table-column>
    ...
    <el-drawer title="添加发展历程" :visible.sync="drawer" :direction="direction" :before-close="handleClose" ref="drawer">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" style="width:50%;padding-left: 60px;box-sizing: border-box;" class="demo-ruleForm">
        <el-form-item label="日期" prop="name">
          <el-date-picker v-model="ruleForm.name" type="month" placeholder="yyyy-MM"></el-date-picker>
        </el-form-item>
        <el-form-item label="描述" prop="name">
          <el-input v-model="ruleForm.name" type="textarea" style="width:50%;"></el-input>
          <div style="font-size:14px;color: rgb(192, 196, 204);">事件描述至多43字</div>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="$refs.drawer.closeDrawer()">立即提交</el-button>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      defaultMsg:'弈霖科技有限公司经营范围包括：通信产品、网络产品、计算机软硬件、手机客户端软件、信息系统软件的技术开发及销售;经营电子商务;电脑平面设计,网页设计,网络技术开发、技术咨询、技术服务,经营广告业务,网络商务服务、数据库服务、数据库管理等。 惠付刷是公司旗下一款刷脸支付产品，提供了刷脸支付，扫码支付，领取会员卡等功能，解决了商家的支付问题。',
      config: {
