...
<!--  网站管理/行业资讯 -->
  <div class="wscn-http404-container">
            ...
            <div class="text item">
              ...
              <div class="" style="padding-top: 20px;">
                <el-table :data="tableData" style="width: 100%">
                  <el-table-column prop="crudName" label="公司名称" align="center"></el-table-column>
                  <el-table-column prop="crudCode" label="客服电话" align="center"></el-table-column>
                  <el-table-column prop="domainClass" label="销售热线" align="center"></el-table-column>
                  <el-table-column prop="createTime" label="传真" align="center">
                    <template slot-scope="scope">
                      <span>{{ parseTime(scope.row.createTime) }}</span>
                    </template>
                  </el-table-column>
                  <el-table-column prop="createTime" label="公司地址" align="center">
                    <template slot-scope="scope">
                      <span>{{ parseTime(scope.row.createTime) }}</span>
                    </template>
                  </el-table-column>
    ...
    <el-drawer title="添加联系我们" :visible.sync="drawer" :direction="direction" :before-close="handleClose" ref="drawer">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" style="width:80%;padding-left: 60px;box-sizing: border-box;" class="demo-ruleForm">
        ...
        <el-form-item label="销售热线" prop="desc">
          <el-input v-model="ruleForm.name" style="width:80%;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="公司地址" prop="name">
          <el-input v-model="ruleForm.name" style="width:80%;"></el-input>
          <div style="width:436px;height:300px;"></div>
        </el-form-item>
        <el-form-item>
