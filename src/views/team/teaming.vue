<template>
 <!--  聚合码管理/聚合码管理 -->
  <div class="wscn-http404-container">
      ...
      <div class="table-box" style="">
        <div class="nav">
          <div class="block" style="width:100%!important;margin-left:15px;margin-bottom:17px;">
            <el-input style="width:190px;height:32px;" placeholder="请输入二维码编号" v-model="value6" clearable></el-input>
            <el-select v-model="ruleForm.region" placeholder="请选择绑定状态">
              <el-option label="未绑定" value="shanghai"></el-option>
              <el-option label="已绑定" value="beijing"></el-option>
            </el-select>
            ...
            <el-button @click="drawer = true" type="primary" class="add-btn" style="">生成聚合码</el-button>
          </div>
        </div>
        <div class="table-content">
          <el-table :data="list" style="width: 100%!important;padding:5px 15px;box-sizing: border-box;" stripe :header-cell-class-name="handlemyclass">
            <el-table-column :cell-class-name="colorblueclass" prop="create_time" label="二维码编号" align="center"></el-table-column>
            <el-table-column prop="product_name" label="是否绑定" align="center"></el-table-column>
            <el-table-column prop="order_status" label="门店名称" align="center">
            ...
            <el-table-column prop="product_amount" label="支付通道" align="center"></el-table-column>
            <el-table-column prop="merchant_order_id" label="创建时间" align="center"></el-table-column>
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                <span class="s-btn" @click="edited(scope.$index,scope.row)">查看</span>
                <span class="s-btn" @click="edited(scope.$index,scope.row)">下载</span>
    ...
    <el-drawer title="生成聚合码" :visible.sync="drawer" :direction="direction" :before-close="handleClose" ref="drawer">
      <div class="code-box">
        <div>
          <div class="radio-box">
            <span>选择数量(张)</span>
          ...
          <div class="zdy-box" v-if="radio==0">
            <span>数量(张)</span>
            <el-input style="width:30%;" placeholder="请输入数量" v-model="value6" clearable oninput="value=value.replace(/[^\d]/g,'')"></el-input>
          </div>
          <hr>
          <div class="btn-box">
            <button>生成二维码图片</button>
            <button>生成二维码压缩文件</button>
          </div>
        </div>
      </div>
    </el-drawer>
