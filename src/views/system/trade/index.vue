<template>
		...
		<div class="head-container">
			<el-form :inline="true" :model="formInline" class="demo-form-inline">
			  <el-form-item label="交易流水号">
				<el-input v-model="formInline.user" placeholder="交易流水号"></el-input>
			  </el-form-item>
			  ...
			  <el-form-item label="交易状态">
				<el-select v-model="formInline.region" placeholder="交易状态">
				  <el-option label="交易成功" value="shanghai"></el-option>
				  <el-option label="交易失败" value="beijing"></el-option>
				  <el-option label="已退款" value="shanghai"></el-option>
	...
	<el-table :data="tableData" style="width: 100%" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
      <el-table-column prop="apdid_token" label="设备编号" width="180" align="center" header-align="center">
      </el-table-column>
      <el-table-column prop="app_name" label="商户名称" width="180" align="center" header-align="center">
      </el-table-column>
      <el-table-column prop="trande_no" label="交易流水号" align="center" header-align="center">
      </el-table-column>
			<el-table-column prop="merchant_info" label="交易金额" align="center" header-align="center">
			</el-table-column>
			<el-table-column prop="create_time" label="交易时间" align="center" header-align="center">
			</el-table-column>
			<el-table-column prop="os_version" label="交易状态" align="center" header-align="center">
				...
				<el-tag type="danger" v-else-if="scope.row.status==2">交易失败</el-tag>
				<el-tag type="info" v-else-if="scope.row.status==3">已退款</el-tag>
				<el-tag type="warning" v-else-if="scope.row.status==4">部分退款</el-tag>
				</template>
			</el-table-column>
    </el-table>
	</div>
