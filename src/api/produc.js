...
// 查询产品组合
export function queryAll(pageNo,pageSize,startDate,endDate) {
  return request({
...
export function alll() {
  return request({
    url: 'api/product?pageNo=1&pageSize=10&id=',
    method: 'get',
...
// 记录
export function record(pageNo,pageSize) {
  return request({
    url: 'api/product/records?pageNo='+pageNo+'&pageSize='+pageSize,
    method: 'GET',
    // data
  })
}
// 查询记录
export function recordQuery(pageNo,pageSize,startDate,endDate) {
  return request({
