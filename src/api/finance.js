...
// 充值财务审核
export function topupCashlist(pageNo,pageSize) {
  return request({
    url: 'api/finance/audit/1?pageNo='+pageNo+'&pageSize='+pageSize,
    method: 'get',
  })
}

//提现财务审核
export function WithdrawCashlist(pageNo,pageSize) {
  return request({
    url: 'api/finance/audit/2?pageNo='+pageNo+'&pageSize='+pageSize,
    method: 'get',
  })
}
// 静态数据
...
// 提现列表
export function withdrawList(pageNo,pageSize) {
  return request({
    url: 'api/finance/logs/2?pageNo='+pageNo+'&pageSize='+pageSize,
    method: 'get',
  })
}
...
// 现金钱包
export function cashlist(date) {
  return request({
    url: 'api/finance/detail/'+date,
    method: 'get',
